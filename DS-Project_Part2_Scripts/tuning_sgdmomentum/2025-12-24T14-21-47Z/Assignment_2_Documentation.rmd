...
rusns_grid <- list(
  ...
  # --- 2. OPTIMIZATION ---
  # Search Learning Speed: Standard (1e-3) vs. Precise (3e-4)
  learning_rate = c(0.001, 0.0005, 0.0001),
