...
```{r}
tic()
training_run("/Users/Jujou/Documents/Repos/GRP-6_DS-Project/DS-Project_Part2_Scripts/Assignment_2_MLP_undersampling.r")
beep(sound=5)
toc()
```

### C. Algorithm Level: Class WeightsB. Algorithm Level: Class Weights
