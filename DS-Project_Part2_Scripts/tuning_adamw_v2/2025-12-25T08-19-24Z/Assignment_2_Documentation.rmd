...
```{r}
# Load all runs from the directory
all_results <- ls_runs(runs_dir = "tuning_adamw")
...
The decision is based on a combination of lowest loss and good accuracy. A loss score of 0.5046 was reached, which shows the most "calibrated" model. It makes fewest confident errors and is therefore most stable engine for future fine-tuning. Furthermore, the accuracy is one of the highest found within the grid, yet with a significantly better loss.
...
Dropout: Test None vs Light vs Moderate dropout1 = c(0.0, 0.2, 0.4), dropout2 = c(0.0, 0.2, 0.4) 
