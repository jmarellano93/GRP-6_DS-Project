...
Furthermore there are other columns to drop, which aren't useful for modelling or have too many missing values. These columns are: - id - member-id -

```{r}
cleaned_data <- cleaned_data %>%
  select(-c(id, member_id, url, desc, zip_code, policy_code, revol_util, mths_since_last_delinq, mths_since_last_major_derog, delinq_2yrs, mths_since_last_record, pub_rec, loan_amnt))
```
