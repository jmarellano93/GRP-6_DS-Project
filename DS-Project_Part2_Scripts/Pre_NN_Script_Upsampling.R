...
# ------------------------------------------------------------------------------
# OPTION 2: UPSAMPLING (Randomly duplicate minority class)
# Pros: Keeps all data. Cons: Risk of overfitting (memorizing duplicates).
# ------------------------------------------------------------------------------
final_recipe <- base_recipe %>%
  step_upsample(TARGET, over_ratio = 1) # 1:1 ratio
strategy_name <- "Upsampling"
