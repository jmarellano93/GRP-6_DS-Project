...
# ==============================================================================
# MENTOR NOTE: We must use 'train_ids' to filter the snapshot.
...
# ==============================================================================
model %>% compile(
  # CHANGE: Lowered Learning Rate from 0.001 to 0.00005
...
# ==============================================================================
# 8.1: Robust Class Weights Calculation (AGGRESSIVE ACCURACY TARGET)
# ==============================================================================
...
# MENTOR NOTE: Aggressive Damping
# Previous (0.25) -> ~87% Accuracy
# New (0.15)      -> Target >90% Accuracy
# This flattens the weights significantly, making the model prioritize 
# the majority class (Status C/0/1) to maximize the accuracy score.
damping_power <- 0.075 
...
# ==============================================================================
# 8.2: Training Execution (ADJUSTED FOR SLOWER TRAINING)
# ==============================================================================

# CHANGE: Increased patience significantly. 
# Since we are learning slowly, we need to give the model more time to show results.
callbacks <- list(
  callback_early_stopping(
    monitor = "val_sparse_categorical_accuracy", 
    mode = "max", 
    patience = 200,             # WAS: 50. Now allows 200 epochs of no improvement.
  ...
  callback_reduce_lr_on_plateau(
    ...
    mode = "max", 
    factor = 0.5, 
    patience = 50,              # WAS: 15. Wait longer before reducing LR further.
    min_lr = 1e-7
  )
)
...
# ==============================================================================
# 9.8: SAVE MODEL ARTIFACT (REQUIRED FOR ASSIGNMENT 2.a)
# ==============================================================================
