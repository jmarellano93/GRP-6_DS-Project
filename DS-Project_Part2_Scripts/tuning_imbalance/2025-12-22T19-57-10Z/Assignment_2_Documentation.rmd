...
-   Number of hidden layers: 2-3 layers

-   Number of units per layer: 512 / 256 (/ 128)
...
```{r}
run_path <- "tuning_architecture_minmax/2025-12-22T10-12-20Z"
...
```{r}
tic()
training_run("Assignment_2_MLP_adamw.r",
             run_dir = "tuning_imbalance")
beep(sound=5)
toc()
```
